...
class HeteroFeature(nn.Module):
    ...
    """
    def __init__(self, h_dict, n_nodes_dict, embed_size, act=None, need_trans=True, all_feats=True, learn_feat_i = False):
        """
        @param h_dict:
        @param n_dict:
        @param embed_size:
